...
<img src="./hero.png" alt="Abhijith Krishna G" />

<br/>

<!-- ANIMATED HEADER BANNER -->

<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Abhijith%20Krishna%20G&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Full-Stack%20Developer%20%7C%20Bioinformatics%20Enthusiast%20%7C%20MCA%20Student&descSize=16&descAlignY=52"/>

<!-- TYPING ANIMATION -->

<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=4000&pause=1000&color=A960FF&center=true&vCenter=true&multiline=true&repeat=true&random=false&width=650&height=100&lines=%F0%9F%A7%AC+From+Bioinformatics+to+Full-Stack+Dev;%F0%9F%8F%86+FOSS+Fest+Hackathon+Winner+2025;%F0%9F%92%BB+12%2B+Languages+%7C+14%2B+Projects+%7C+%E2%88%9E+Curiosity" alt="Typing SVG" /></a>
...
```yaml
name: Abhijith Krishna G
location: Bangalore, Karnataka, India 🇮🇳
education:
  current: MCA @ PES University
  previous: BSc (Bioinformatics, CS & Stats) @ REVA University
...
currently:
  learning: [ "Advanced Cloud Architectures", "Deep Learning" ]
  building: [ "Full-Stack Web Apps", "Bioinformatics Tools" ]
  exploring: [ "ML/DL in Genomics", "Cross-Platform Development" ]

achievements:
  - "🏆 FOSS Fest Hackathon 2025 Winner (€1000 Prize)"
  - "🌍 Competed against 500+ teams worldwide"

fun_fact: "Started with DNA sequences, now I write code sequences 🧬→💻"
```
...
> [!TIP]
> 🏆 **TELEports** — Won the **FOSS Fest Winter Hackathon 2025** (€1000 Prize)! An enhanced Telegram client for Ubuntu Touch built with TDLib, featuring a QML frontend with C++ backend. Competed against **500+ teams worldwide**.

<div align="center">

|           🎯 Project           | 📝 Description                            |           🛠️ Tech           |
| :-----------------------------: | :---------------------------------------- | :---------------------------: |
|       **TELEports**       | Enhanced Telegram client for Ubuntu Touch |   `C++` `QML` `TDLib`   |
|       **Bat Chat**       | Real-time chat web application            |  `Node.js` `WebSockets`  |
| **Virtual Herbal Garden** | Interactive herbal knowledge platform     |    `Web` `Full-Stack`    |
|         **GenG**         | Multi-purpose web application suite       |   `JavaScript` `React`   |
|       **UB Notes**       | Cross-platform note-taking app            |   `Flutter` `Firebase`   |
|        **Gene DB**        | Bioinformatics gene database tool         |   `Python` `BioPython`   |
|       **NucleoIDE**       | DNA/RNA sequence analysis IDE             | `Python` `Bioinformatics` |
|  **Pairwise Alignment**  | Sequence alignment visualizer             |   `Python` `Algorithms`   |
|   **Sequence Analyzer**   | Genomic sequence analysis tool            | `Python` `Bioinformatics` |
...
| | |
|:---|:---|
| 🧬 | Started with **Bioinformatics**, fell in love with **Software Development** |
| 💻 | Can code in **12+ programming languages** (and counting!) |
| 🏆 | **FOSS Fest Hackathon Winner 2025** — competed against 500+ teams |
| 🎓 | Pursuing **MCA** at PES University, Bangalore |
| 🌍 | Open to collaboration on **bioinformatics & full-stack** projects |
| 🔬 | Passionate about **ML/DL applications in biology** |
| ⚡ | Coffee-powered developer ☕ — _but actually tea_ 🍵 |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/abhijith-krishna-g/)
...
║   🤖  ML/DL Applications in Biology                             ║
║   🌟  Open-Source Contributions                                  ║
║   🎯  Innovative Ideas That Merge Tech + Biology                ║
║                                                                  ║
